...
return	array(	
	...
	'shop'=>array('name'=>'商城','child'=>array(
			...
			array('name' => '商家','child'=>array(
					...
					//array('name' => '店铺帮助', 'act'=>'helpList', 'op'=>'Article'),
			         array('name' => '线下实体茶馆', 'act'=>'shop_list', 'op'=>'Store'),
			         array('name' => '茶艺师列表', 'act'=>'tea_list', 'op'=>'Tea'),
			)),
			array('name' => '订单','child'=>array(
					array('name' => '订单列表', 'act'=>'index', 'op'=>'Order'),
			         array('name' => '茶艺师订单', 'act'=>'index', 'op'=>'Teaorder'),
    ...
    'community'=>array('name'=>'社区活动','child'=>array(
				
				array('name' => '社区帖子','child'=>array(
						array('name' => '帖子列表', 'act'=>'articleList', 'op'=>'Community'),
						//array('name' => '社区公告', 'act'=>'communityList', 'op'=>'Community'),
				        array('name' => '评论列表', 'act'=>'commentList', 'op'=>'Community'),
				)),
                array('name' => '活动管理','child'=>array(
                    array('name' => '活动列表', 'act'=>'activeList', 'op'=>'Active'),
                    array('name' => '评论列表', 'act'=>'commentList', 'op'=>'Active'),
                    //array('name' => '文章分类', 'act'=>'categoryList', 'op'=>'Active'),
                )),
